...
import com.ali.interfacesassignment.model.VehiclesList
...
class ItemDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val item =intent.getSerializableExtra(ItemDetailFragment.ARG_ITEM_ID) as Vehicle
        ...
        favourite_switch.setOnClickListener {
            if(item?.favorite==false){
               VehiclesList.vehicles[item.index].favorite=true
                favourite_switch.isChecked=true
            }
            else
                VehiclesList.vehicles[item.index].favorite=false
           favourite_switch.isChecked=false
